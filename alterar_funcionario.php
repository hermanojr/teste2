        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <select class=form-control name="cargo"  value="<?=$row['cargo']?>">  
                                <option <?php if($row['cargo'] == 'Proprietario') { ?>selected<?php } ?> >Prorpietário</option>
                                <option <?php if($row['cargo'] == 'Recepcionista') { ?>selected<?php } ?> >Recepcionista</option>
                                <option <?php if($row['cargo'] == 'Atendente') { ?>selected<?php } ?> >Atendente</option>
                                <option <?php if($row['cargo'] == 'Assitente') { ?>selected<?php } ?> >Assitente</option>                                
                            </select>
                        </div>
                    </div>
