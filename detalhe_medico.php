    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <a href="alterar_medico.php?id=<?=$_GET['id']?>" class="btn btn-primary">Editar</a>
                <a href="lista_medicos.php" class="btn btn-link">Voltar</a>
                <a href="delete_medico.php?id=<?=$_GET['id']?>" class="btn btn-danger float-right">Excluir</a>
            </div>
        </div>
